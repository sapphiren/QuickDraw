...
function updateCanvas() {
    ...
    console.log(quick_draw_data_set[random_number])
    document.getElementById("givenSketch").innerHTML = "Sketch to be drawn is: " + sketch; 
...
function gotResult(error, results) {
    ...
    document.getElementById('confidence').innerHTML = "Confidence/Accuracy: " + Math.round(results[0].confidence * 100) + '%';
